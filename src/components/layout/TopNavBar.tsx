      ...
      <div className="flex items-center gap-1 shrink-0">
        ...
        {user && (
          <button
            onClick={() => logout()}
            title="Sign out"
            className="py-1 px-2 rounded-[6px] bg-bg-tertiary border border-border-color text-text-secondary text-[11px] cursor-pointer hover:text-alert-critical transition-colors"
          >
            ⏏
          </button>
        )}
