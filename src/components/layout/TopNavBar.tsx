    ...
    >
      ...
      <div className="flex items-center gap-1 shrink-0">
        ...
        <button
          onClick={() => logout()}
          title="Sign out"
          className="h-8 px-2 rounded-[6px] text-[11px] text-text-muted hover:text-text-primary border border-border-color bg-bg-tertiary transition-colors cursor-pointer"
